<?php
class Dextrous_Extendcatalog_Block_Bestsellers_Home_List extends Dextrous_Extendcatalog_Block_Bestsellers_List
{
		...
		if(Mage::getStoreConfig('extendcatalog/config1/max_product'))
        {
            $products->setPageSize(Mage::getStoreConfig('extendcatalog/config2/max_product'));
        }
